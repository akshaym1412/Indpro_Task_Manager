    ...
    >
      <div className="col-span-2 flex">
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={() => {toggleTaskSelection(task.id),setEditTask(false)}}
      ...
      <div className="relative col-span-1 text-center hidden lg:block">
        ...
        {option === task.id && (
          ...
          >
            <p className="cursor-pointer hover:text-blue-600 flex items-center gap-2" onClick={() => handleTask(task.id)}>
            <RiEdit2Fill /> Edit
            </p>
            <p
